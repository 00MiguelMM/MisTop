...
const initialItems: RankingItem[] = [
  {
    ...
    title: "Interstellar",
    description:
      "Una película de ciencia ficción sobre el espacio, el tiempo y la familia.",
    category: "peliculas",
    status: "terminada",
  ...
  },
  {
    ...
    title: "Oppenheimer",
    description:
      "Una película biográfica sobre ciencia, poder y responsabilidad.",
    category: "peliculas",
    status: "pendiente",
    genre: "Biografía",
    year: 2023,
  ...
  },
  {
    ...
    title: "Breaking Bad",
    description:
      "Una serie intensa sobre decisiones, ambición y consecuencias.",
    category: "series",
    status: "terminada",
  ...
  },
  {
    ...
    description:
      "Una serie española de atracos, tensión y personajes muy reconocibles.",
    category: "series",
    status: "viendo",
    genre: "Thriller",
    year: 2017,
